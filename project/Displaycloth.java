 ...
 * @author Girdhari lal
 */
public class Displaycloth extends JFrame implements ActionListener{
    JPanel panel;
    JButton sho;
    JTable table;
      JScrollPane sp;
    ...
    public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Displaycloth dc= new Displaycloth();
      ...
      if("show".equals(e.getActionCommand()))
       {
         ...
         String query="select * from cloths";
